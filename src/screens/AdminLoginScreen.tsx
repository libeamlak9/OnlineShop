...
export function AdminLoginScreen() {
  ...
  async function handleLogin() {
    ...
    if (!email || !password) {
      await showAlert('Not configured', 'Admin credentials are not set in the environment.');
      return;
    }
    ...
    if (profileError || profile?.role !== 'admin') {
      ...
      await showAlert('Access denied', 'This account does not have admin privileges.');
      setPassword('');
      return;
    }
