...
export function AdminDashboardScreen() {
  ...
  async function handleDelete(id: string) {
    try {
      ...
      await showAlert('Error', 'Failed to delete item. Please try again.');
    }
  }
  ...
  async function handleAddCategory() {
    ...
    if (categories.includes(trimmed)) {
      await showAlert('Duplicate', `${trimmed} already exists.`);
      return;
    }
    try {
      ...
      await showAlert('Error', 'Failed to add category. Please try again.');
    }
  }
  ...
  async function handleRemoveCategory(category: string) {
    ...
    try {
      ...
      await showAlert('Error', 'Failed to remove category. Please try again.');
    }
  }
    ...
    <>
      ...
      <Screen scroll noPadding edges={['left', 'right']}>
        ...
        <View style={[styles.twoColumn, isDesktop && styles.twoColumnDesktop]}>
          <View style={[styles.column, styles.categoriesColumn, isDesktop && styles.columnDesktop]}>
          ...
          <View style={[styles.column, styles.productsColumn, isDesktop && styles.productsColumnDesktop]}>
